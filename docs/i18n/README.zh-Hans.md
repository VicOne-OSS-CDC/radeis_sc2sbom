<a href="../../README.md">English</a> | 简体中文 | <a href="README.zh-Hant.md">繁體中文</a> | <a href="README.ja.md">日本語</a>
...
**快速 SBOM 生成器。** 多生态系统支持，具备独特能力：**唯一**支持 C/C++ Autotools、ROS 2、Git 子模块、CMake ExternalProject 和 AUTOSAR BSW 的工具。
...
完整历史记录请参阅 [CHANGELOG.md](../../CHANGELOG.md) 和 [docs/WHATS_NEW.md](../WHATS_NEW.md)。
...
详见 [docs/BENCHMARKS.md](../BENCHMARKS.md)。
